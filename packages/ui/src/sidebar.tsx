...
/** Internal-only: returns context or null (no throw). Used by sub-components
 *  that may render outside a SidebarProvider (e.g. in a demo page). */
...
const SidebarProvider = React.forwardRef<HTMLDivElement, SidebarProviderProps>(
  (
    ...
    // Internal open state (controlled or uncontrolled)
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Gap placeholder for the sidebar */}
        <div
          className={cn(
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          hidden={ctx ? ctx.state !== "collapsed" || ctx.isMobile : true}
          {...tooltip}
        />
      </Tooltip>
    );
