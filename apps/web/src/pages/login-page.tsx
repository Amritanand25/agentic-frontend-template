...
export default function LoginPage() {
  ...
  const { login, loginWithOAuth, isLoading, error, clearError } =
    useAuthStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Login auto-selects org + tenant, so go straight to the app
    const { isAuthenticated, currentOrg, currentTenant } =
      useAuthStore.getState();

    if (isAuthenticated && currentOrg && currentTenant) {
