...
import { DataGrid, Button, type Column } from "@repo/ui";
...
function ShimmerCell({ width }: { width?: string }) {
  return (
    <div
      ...
      style={{ width: width ?? `${50 + Math.random() * 40}%` }}
    >
  ...
  return (
    ...
    >
      <div>
        ...
        >
          Skeleton shimmer effect while data is loading. Cells show animated
          placeholders until the real data arrives.
        </p>
      </div>
